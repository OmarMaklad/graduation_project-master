...
AdminChatModel serviceChatModelFromJson(String str) => AdminChatModel.fromJson(json.decode(str));

String serviceChatModelToJson(AdminChatModel data) => json.encode(data.toJson());
