...
import 'package:graduation_project/Admin/views/chat/view.dart';
import 'package:graduation_project/core/router.dart';

import '../../../../../constants.dart';

class AdminChatsCard extends StatelessWidget {
  final String name;
  final String date;
  final int id;
  const AdminChatsCard({this.name, this.date, this.id});
  @override
  Widget build(BuildContext context) {
    final height = MediaQuery.of(context).size.height;
    return GestureDetector(
      onTap: ()=> MagicRouter.navigateTo(AdminChatView(
        date: date,
        name: name,
        chatId: id,
      )),
