...
import 'package:graduation_project/CustomService/chat/view.dart';
import 'package:graduation_project/core/router.dart';
import '../../../constants.dart';

class ServiceChatsCard extends StatelessWidget {
  final String name;
  final String date;
  final int id;
  const ServiceChatsCard({this.name, this.date, this.id});
  @override
  Widget build(BuildContext context) {
    final height = MediaQuery.of(context).size.height;
    return GestureDetector(
      onTap: ()=> MagicRouter.navigateTo(ServiceChatView(
        date: date,
        name: name,
        chatId: id,
      )),
