...
class SharedHelper {
  ...
  static Future<void> cacheUser()async{
    ...
    _prefs.setString('type', _userSingleton.type);
    ...
    _prefs.setString('apiToken', _userSingleton.apiToken);
  ...
  static Future<void> getUser()async{
    ...
    _userSingleton.type = _prefs.getString('type');
    _userSingleton.apiToken = _prefs.getString('apiToken');
