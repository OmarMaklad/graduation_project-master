...
class MakerChatController {
  MakerChatModel _chatModel =MakerChatModel();
  NetWork _netWork = NetWork();
  Future<MakerChatModel> getMessage(int id) async {
    ...
    print(response);
    if (response !=null) {
      _chatModel = MakerChatModel.fromJson(response);
    } else {
      _chatModel = MakerChatModel();
    }
