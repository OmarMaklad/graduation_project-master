...
class SalerChatController {
  SalerChatModel _chatModel =SalerChatModel();
  NetWork _netWork = NetWork();
  Future<SalerChatModel> getMessage(int id) async {
    ...
    if (response !=null) {
      _chatModel = SalerChatModel.fromJson(response);
    } else {
      _chatModel = SalerChatModel();
    }
