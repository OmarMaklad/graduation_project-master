...
import 'package:graduation_project/saler/chat/view.dart';
import '../../../constants.dart';

class SalerChatsCard extends StatelessWidget {
  final String name;
  final String date;
  final int id;
  const SalerChatsCard({this.name, this.date, this.id});
  @override
  Widget build(BuildContext context) {
    final height = MediaQuery.of(context).size.height;
    return GestureDetector(
      onTap: ()=> MagicRouter.navigateTo(SalerChatView(
        date: date,
        name: name,
        chatId: id,
      )),
